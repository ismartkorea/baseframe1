...
router.get('/', function(req, res) {
    ...
    if(ss.usrLevel == '000' || ss.usrLevel == '001' || ss.usrLevel == '002') {
        ...
        conn.query('SELECT count(*) as cnt from tbl_product x'
            ...
            + ' WHERE s.cateName = "아프리카별풍선")' + addSQL
            ...
            function (err, results) {
                if (err) {
                    ...
                    res.render('./admin/product5/list', {
                        product: results[1],
                        srchType: srchType,
                        srchText: srchText,
                        page: page,
    ...
    conn.query('SELECT comm_cd as commCd, comm_nm as commNm FROM tbl_commcd WHERE p_comm_cd = "SD00";'
        ...
        function(err, results) {
            if(err) {
                ...
                res.render('./admin/product5/new', {'cList' : results[0], 'cList2' : results[1], 'session' : ss});
            }
        });
});
    ...
    conn.query('SELECT p_no as pNo, p_code as pCode, p_div as pDiv, p_opt_btn_dis_yn as pOptBtnDisYn, p_nm as pNm,'
        ...
        function(err, results) {
            if(err) {
                ...
                res.render('./admin/product5/edit', {'result' : results[0][0], 'cList' : results[1], 'cList2' : results[2], 'session' : ss});
            }
        });
});
    ...
    conn.query('SELECT p_no as pNo, p_code as pCode, p_div as pDiv, p_nm as pNm, p_price as pPrice, p_smmry as pSmmry, p_desc as pDesc,'
        ...
        function(err, results) {
            if(err) {
                ...
                res.render('./admin/product5/view', {result : results[0], cList : results[1], session : ss});
            }
        });
});
...
router.post('/edit/do', function(req, res) {
    ...
    var pPrice = req.body.pPrice !=null ? req.body.pPrice : 0;
    var pDiscPrice = req.body.pDiscPrice !=null ? req.body.pDiscPrice : 0;
    var pDiscPercent = req.body.pDiscPercent !=null ? req.body.pDiscPercent : '';
    var pDesc = req.body.pDesc !=null ? req.body.pDesc : '';
    var pSmmry = req.body.pSmmry !=null ? req.body.pSmmry : '';
    var pDisplayYn = req.body.pDisplayYn !=null ? req.body.pDisplayYn : '';
...
router.get('/banner', function(req, res, next) {
    ...
    conn.query(SQL, [], function(err, results) {
        if(err) {
            ...
            res.status(200).render('./admin/product5/banner/view', {'result' : results[0], 'session' : ss});
        }
    })
...
router.get('/banner/edit', function(req, res, next) {
    ...
    conn.query(SQL, [], function(err, results) {
        if(err) {
            ...
            console.log('call banner ');
            console.log('results : ', JSON.stringify(results) + '\n');
            res.status(200).render('./admin/product5/banner/edit', {'result' : results[0], 'session' : ss});
        }
    })
    ...
    conn.query('SELECT @rownum:=@rownum+1 as num, s.cateNo, s.cateName from (SELECT t1.category_no as cateNo,'
        ...
        function(err, results) {
            if(err) {
                ...
                res.render('./admin/product5/category/list', {rList : results, session : ss});
            }
        }
    );
    ...
    conn.query('INSERT INTO tbl_product_category(`name`) values( ? );',
        ...
        function(err) {
            if(err) {
                ...
                res.redirect('/admin/product5/category');
            }
        });
});
    ...
    conn.query('SELECT @rownum:=@rownum+1 as num, s.cateName1, s.cateName2, s.cateNo FROM ('
        ...
        function(err, results) {
            if(err) {
                ...
                res.render('./admin/product5/category/listM', {rList : results[0], rList2 : results[1], session : ss});
            }
        }
    );
    ...
    conn.query('INSERT INTO tbl_product_category(`name`, `parent_no`) values(?, ?);',
        ...
        function(err) {
            if(err) {
                ...
                res.redirect('/admin/product5/category2');
            }
        });
});
    ...
    conn.query('SELECT @rownum:=@rownum+1 as num, s.cateName1, s.cateName2, s.cateName3, s.cateNo FROM ('
        ...
        function(err, results) {
            if(err) {
                ...
                res.render('./admin/product5/category/listS', {rList : results[0], rList2 : results[1], cList : results[2], srchCategory1 : srchCategory1 , srchCategory2 : srchCategory2, session : ss});
            }
        }
    );
    ...
    conn.query('INSERT INTO tbl_product_category(`name`, `parent_no`) values(?, ?);',
        ...
        function(err) {
            if(err) {
                ...
                res.redirect('/admin/product5/category3');
            }
        });
});
